...
app.get('/identity', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const identityRef = yield ref2.get();
    const identityOb = [];
    identityRef.forEach(identity => identityOb.push(identity.data()));
...
app.post('/identity', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const addNewIdentity = yield ref2.add(req.body);
...
app.delete('/removeIdentity/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
    const deleteDocIdentity = yield db.collection('identity').doc(req.params.id).delete();
